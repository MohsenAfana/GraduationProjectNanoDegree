    ...
    public void onViewClicked() {
        ...
        if (!(TextUtils.isEmpty(display_name)) && !(TextUtils.isEmpty(email)) && !(TextUtils.isEmpty(password))) {
            ...
            Snackbar snackbar = Snackbar.make(signupLayout
                    , getResources().getString(R.string.please_fill_all_spaces), Snackbar.LENGTH_LONG);
            snackbar.show();
        ...
        mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    users_Reference.setValue(user_info_map).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                Snackbar snackbar = Snackbar.make(signupLayout
                                        , getResources().getString(R.string.something_went_wrong), Snackbar.LENGTH_LONG);
                    ...
                    Log.d(TAG, "onComplete: " + task.getException().toString());
                    Toast.makeText(SignUpActivity.this,getResources().getString(R.string.error_happened), Toast.LENGTH_SHORT).show();
                }
            }
        });
